...
class _FaceRegisterState extends State<FaceRegister> {
  ...
  FaceExtractionConnection faceExtractionConnection = FaceExtractionConnection(globals.IP, globals.PORT);
  ...
  Future<void> faceUpdates(BuildContext context) async {
    if (_formKey.currentState.validate()) {
      ...
      faceExtractionConnection.faceRegisterRequest(request,globals.TOKEN).then((value) {
